...
fetch -o /usr/local/pkg -q http://app.unimedsc.com.br/pf2ad/samba.inc
fetch -o /usr/local/pkg -q http://app.unimedsc.com.br/pf2ad/samba.xml
...
cd /usr/local/pkg
fetch -o - -q http://app.unimedsc.com.br/pf2ad/squid_winbind_auth.patch | patch -b -p0 -f
fetch -o /usr/local/pkg -q http://app.unimedsc.com.br/pf2ad/squid.inc
