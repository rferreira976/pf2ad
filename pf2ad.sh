...
fetch -o /usr/local/pkg -q https://github.com/rferreira976/pf2ad/blob/2.4.4-SAMBA4/samba.inc
fetch -o /usr/local/pkg -q https://github.com/rferreira976/pf2ad/blob/2.4.4-SAMBA4/samba.xml
...
cd /usr/local/pkg
fetch -o - -q https://github.com/rferreira976/pf2ad/blob/2.4.4-SAMBA4/squid_winbind_auth.patch | patch -b -p0 -f
fetch -o /usr/local/pkg -q https://github.com/rferreira976/pf2ad/blob/2.4.4-SAMBA4/squid.inc
